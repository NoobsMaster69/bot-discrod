module.exports = {
  ...
  Token: process.env.Token || "MTEyMjg4MTQ3MDgxMDMwNDY0NQ.GFXaUe.nWD6s6x6MpJwh4Y_-WHUofIoZwZM7ZSi_DcVPE", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1122881470810304645", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "kbUbqpMBocXFtTArN_LJex_JJ9z-DtTK", // Discord Client Secret
  ...
  Lavalink: {
    ...
    host: "lavalink-replit.noobsmaster69.repl.co", //- The host name or IP of the lavalink server.
